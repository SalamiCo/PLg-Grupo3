...
public final class CompilerUI extends JFrame {
	 ...
	 * */
	private enum Views {COMPILER, DEBUGGER};
	 ...
	 * ventana, menú principal y panel principal con los paneles de las vistas
	 */
	private void initUI(){
	...
	/**
	 * Inicializa el menú principal, que consta de los siguientes apartados:
	 * - Menú Archivo: opciones típicas de manejo de ficheros
	 * - Menú Edición: opciones típicas de edición de ficheros
	 * - Menú Vistas:  permite cambiar la vista de trabajo
	 * - Menú Acciones: permite ejecuciones asociadas a la vista actual
	 * - Menú Ayuda: muestra documentos de ayuda al usuario y créditos
	 * */
	...
	/**
	 * Inicializa el menú Archivo con los siguientes Items:
	 * - Nuevo: crea un nuevo archivo
	 * - Abrir: abre un archivo del sistema de ficheros
	 * - Guardar: guarda el contenido actual del área de texto
	 * - Guardar como: guarda el contenido actual del área de texto en un archivo
	...
	/**
	 * Inicializa el menú Editar con los siguientes Items:
	 * - Deshacer y Rehacer
	 * - Cortar, Copiar, Pegar
	 * - Seleccionar todo
	 * - Buscar
	...
	/**
	 * Inicializar el menú Vista con un CheckBox:
	 * si se encuentra desmarcado muestra la vista "compilador", 
	 * si se encuentra marcado muestra la vista "debug"
	 * */
...
//	}
	...
	/**
	 * @return Inicializa un área de edición de código fuente
	 * (vista compilador)
	 * */
	...
	/**
	 * @return Inicializa un área de edición de código máquina
	 * (vista debug)
	 * */
	...
	/**
	 * @return Inicializa las pestañas de Log y Errores de compilación
	 * (vista compilador)
	 * */
	...
	/**
	 * @return Inicializar las pestañas de Consola y Errores en tiempo de ejecución
	 * (vista debug)
	 * */
	private JTabbedPane initConsoleTabs() {
		...
		consoleTabbedPane.addTab("Console", iconConsole, panel1,
		                  "I/O Console");

		JComponent panel2 = new JPanel(new BorderLayout());
		errorsArea = new JTextPane();
		panel2.add(errorsArea, BorderLayout.CENTER);
		consoleTabbedPane.addTab("Errors", iconError, panel2,
		                  "Shows runtime errors");
	...
	/**
	 * @return Inicializa las pestañas para la Tabla de Símbolos y lista de Tokens
	 * (vista compilador)
	 * */	
	private JTabbedPane initSymbolTabs() {
		...
		symTabbedPane.addTab("Symbol table", iconTable, panel1,
		                     "Shows symbol table content");

		JComponent panel2 = new JPanel();
		symTabbedPane.addTab("Tokens", iconToken, panel2,
		                     "Shows token list");
	...
	/**
	 * @return Inicializa las pestañas de Símbolos de Debug y de Máquina Virtual
	 * (vista debug)
	 * */
	private JTabbedPane initDebugTabs() {
		...
		JComponent panel1 = new JPanel();
		dbgTabbedPane.addTab("Debug", iconDebug, panel1,
		                     "Shows debug symbols");
		
		JComponent panel2 = new JPanel();
		dbgTabbedPane.addTab("Virtual Machine", iconMachine, panel2,
		                     "Shows virtual machine status");		
	...
	public FileHandler getFileHandler(){
		FileHandler file;
		switch(view){
			case COMPILER: 	file = sourceFile; 
							break;
			case DEBUGGER:	file = bytecodeFile;
							break;
			default:		file = sourceFile;
							break;
		}
		return file;
	}
	...
	/**
	 * Pregunta si puede cerrar los manejadores de fichero, 
	 * en caso afirmativo procede al cierre de la aplicación
	 * */
